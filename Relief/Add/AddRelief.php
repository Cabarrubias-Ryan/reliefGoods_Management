...
<head>
    ...
    <title>Distribute relief goods</title>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <a href="../Reliefs.php" class="btn-close"></a>
            </div>
            <div class="modal-body">
                <form action="AddReliefPro.php" method="post" id="myForm">
                    <div class="inputField">
                        <div>
                            <input type="hidden" name="Resident_id" value="<?= htmlspecialchars($_GET['resident_id'])?>">
                        </div>
                        <div>
                            <label for="Name">Relief Goods Description:</label>
                            <select name="Goods" required>
                                <option hidden></option>
                                <?php
                                    $reliefpacks = AllReliefPacks($connection);

                                    if(!empty($reliefpacks)){
                                        foreach($reliefpacks as $Data){

                                            ?>
                                                <option value="<?= $Data['relief_id']?>"><?= $Data['description']?></option>
                                            <?php
                                        }
                                    }
                                ?>
            ...
            <div class="modal-footer">
                <a href="../Reliefs.php" class="btn btn-secondary" data-bs-dismiss="modal">Close</a>
