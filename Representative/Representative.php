        ...
        <div class="head-title">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a class="active" href="#">List of Representative</a>
                    </li>
                </ul>
            </div>
            <a href="Insert/Insert.php" class="btn-download"><i class='bx bxs-user-plus'></i> New Representative</a>
        </div>

        <div class="table">
            <div class="table-header">
                <div class="header__item"><a id="name" class="filter__link" href="#">Name</a></div>
                <div class="header__item"><a id="wins" class="filter__link filter__link--number" href="#">Purok</a></div>
                <div class="header__item"><a id="wins" class="filter__link filter__link--number" href="#">Contact #</a></div>
                <div class="header__item"><a id="total" class="filter__link filter__link--number" href="#">Distributed Goods</a></div>
                        ...
                        foreach ($resident as $Data) {
                            if($Data['status'] == "Active"){
                                ...
                                <div class="table-row">        
                                    ...
                                    <div class="table-data"><?=  htmlspecialchars(isset($Data['goodsDistributed']) ? $Data['goodsDistributed'] : 0)?></div>
